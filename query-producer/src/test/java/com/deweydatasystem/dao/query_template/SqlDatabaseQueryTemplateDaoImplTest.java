...
//import com.deweydatasystem.dao.query_template.QueryTemplateDaoFactory.SqlStringHolder;
...
public class SqlDatabaseQueryTemplateDaoImplTest {
    ...
    private final SqlDatabaseQueryTemplateDaoImpl sqlDatabaseQueryTemplateDao = new SqlDatabaseQueryTemplateDaoImpl(qbConfig);

    @BeforeClass
    public static void beforeClass() {
        embeddedDatabase = buildEmbeddedDatabase();
        qbConfig = mock(QbConfig.class);

        when(qbConfig.getQueryTemplateDataSource()).thenReturn(
                mock(QbConfig.QueryTemplateDataSource.class)
        );
        when(qbConfig.getQueryTemplateDataSource().getDataSource())
                .thenReturn(embeddedDatabase);
    }
