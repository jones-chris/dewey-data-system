...
public class QueryTemplateServiceImplTest {
    ...
    public void getNames_callsDaoMethodAndReturnsResult() {
        Set<String> expectedNames = Set.of("bob", "joe", "sam");
        when(this.queryTemplateDao.listNames(anyString()))
                .thenReturn(expectedNames);

        Set<String> resultingNames = this.queryTemplateService.getNames("databaseName");
