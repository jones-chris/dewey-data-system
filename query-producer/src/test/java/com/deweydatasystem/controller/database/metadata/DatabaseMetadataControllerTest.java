...
public class DatabaseMetadataControllerTest {
    ...
    @Test
    public void getDatabases_returns404IfCacheMissException() throws Exception {
        when(this.databaseMetaDataService.getDatabases())
    ...
    public void getSchemas_returns200() throws Exception {
        ...
        this.mockMvc.perform(
                get("/api/v1/metadata/database/schema")
        ).andDo(
                print()
        ).andExpect(
                status().is(200)
    ...
    @Test
    public void getSchemas_returns404IfCacheMissException() throws Exception {
        when(this.databaseMetaDataService.getSchemas(anyString()))
                .thenThrow(CacheMissException.class);
    ...
    public void getTablesAndViews_returns200() throws Exception {
        ...
        this.mockMvc.perform(
                get("/api/v1/metadata/database/schema1&schema2/table-and-view")
        ).andDo(
                print()
        ).andExpect(
                status().is(200)
    ...
    @Test
    public void getTablesAndViews_returns404IfCacheMissException() throws Exception {
        when(this.databaseMetaDataService.getTablesAndViews(anyString(), anyString()))
                .thenReturn(
                        List.of(
                                new Table()
    ...
    public void getColumns_returns200() throws Exception {
        ...
        this.mockMvc.perform(
                post("/api/v1/metadata/database/schema/tables/column")
    ...
    @Test
    public void getColumns_returns404IfCacheMissException() throws Exception {
        when(this.databaseMetaDataService.getColumns(anyString(), anyString(), anyString()))
                .thenThrow(CacheMissException.class);
