...
import com.deweydatasystem.exceptions.ExceptionMapper;
...
public class QueryTemplateControllerTest {
    ...
    /**
     * This tests that the {@link ExceptionMapper}'s default behavior of returning a 400 response
     ...
     * is needed to test this {@link ExceptionMapper} behavior, so this test has been added here.
     *
