...
class SaveQuery extends Component {
	...
	render() {
		...
		return (
			<Modal show={true} backdrop='static' size="lg" onHide={this.props.onCloseHandler} centered>
		        ...
		        <Modal.Footer>
		          ...
		          <Button variant="outline-primary" onClick={this.props.onSaveQuery}>
		            Save
		          </Button>
		        </Modal.Footer>
    		...
    		saveQuery().then(async response => {
		        if (response.ok) {
		            ...
		            dispatch({
		                ...
		                payload: {
		                    messageText: 'Query saved successfully',
		            ...
		            if (data.hasOwnProperty('message')) {
		                ...
		                throw Error('An error occurred when saving the query');
		            }
		        }
		    }).catch(reason => {
		        dispatch({
		                ...
		                payload: {
		                    messageText: reason,
		                    type: Constants.MessageModalType.ERROR,
		                    imageUrl: null
		                }
		            });
		    });
