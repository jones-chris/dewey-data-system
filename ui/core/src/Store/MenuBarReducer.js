...
const menuBarReducer = (state = initialState, action) => {
    ...
    switch (action.type) {
        ...
        case 'UPDATE_UI_MESSAGES':
            ...
            return newState;
        case Constants.SHOW_QUERY_BUILDER_APPLICATION:
            hideAllElements(newState);
            newState.schemasAndTables.isHidden = false;
            return newState;
        case Constants.SHOW_DATA_CATALOG_APPLICATION:
            hideAllElements(newState);
            newState.dataCatalog.isHidden = false;
            return newState;
        case Constants.SHOW_RAW_SQL_APPLICATION:
            hideAllElements(newState);
            newState.rawSql.isHidden = false;
            return newState;
        default:
            return state;
    }
