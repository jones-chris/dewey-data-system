...
import { getAvailableTablesAndViews, getAvailableColumns } from "../actions/DatabaseMetadataActions";
...
const mapDispatchToProps = (dispatch) => {
    return {
        onSelectSchemaHandler: (target) => {
            ...
            getAvailableTablesAndViews(selectedDatabaseName, joinedSchemaString)
