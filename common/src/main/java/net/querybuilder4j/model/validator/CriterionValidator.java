...
import static net.querybuilder4j.model.criterion.Operator.isNotNull;
import static net.querybuilder4j.model.criterion.Operator.isNull;
    ...
    public static void assertSqlIsClean(Criterion criterion) {
        ...
        if (! values.isEmpty()) {
            for (String value : values) {
                SqlValidator.assertSqlIsClean(value);
            }
        }
    }
