...
import static net.querybuilder4j.config.CacheType.IN_MEMORY;
import static net.querybuilder4j.config.CacheType.REDIS;
...
public class DatabaseMetadataCacheFactory extends AbstractFactoryBean<DatabaseMetadataCacheDao> {
    ...
    // todo:  Move this method into RedisDatabaseMetadataCacheDaoImpl class.
    /**
